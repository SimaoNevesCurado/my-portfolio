    ...
    return (
        <section className="pb-16 lg:py-24">
            <div className="container">
                <p className="uppercase text-center font-semibold tracking-widest bg-gradient-to-r from-emerald-500 to-teal-700 text-transparent bg-clip-text" >Portfolio Highlights</p>
                <h2 className="font-serif text-3xl md:text-5xl text-center mt-6 ">Featured Projects</h2>
                <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto ">Here, you'll find a selection of work that highlights my skills, creativity, and dedication to solving challenges</p>
                ...
                <div className="flex justify-center">
                    <button className="bg-white text-gray-950 h-12 w-full rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8 md:w-auto md:px-6">
                        <span><a href="https://github.com/SimaoNevesCurado">Explore More Projects</a></span>
                        <ArrowUpRight className="size-4" />
                    </button>
                </div>
            </div>
